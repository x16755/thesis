...
public class PositionDataRight : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StreamWriter sw = File.AppendText(Variables.folder + "PositionDataRight" + Variables.participant + ".csv");
    ...
    void Update()
    {
        ...
        StreamWriter sw = File.AppendText(Variables.folder + "PositionDataRight" + Variables.participant + ".csv");// This is where the data will be written
